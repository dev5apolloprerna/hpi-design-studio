...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="card p-4">
            <h6 class="fw-semibold mb-3">Add Testimonial</h6>
            <form action="{{ route('admin.testimonials.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    @if ($categories->isEmpty())
                        <div class="form-text text-danger">No Testimonial categories yet. <a href="{{ route('admin.categories.create') }}">Create one first</a>.</div>
                    @endif
                </div>
                <div class="mb-3">
